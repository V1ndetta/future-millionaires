...
const fields: FieldSpec[] = [
  { name: "title", label: "Название", required: true }, { name: "category", label: "Категория", required: true }, { name: "imageUrl", label: "URL изображения", required: true, full: true }, { name: "alt", label: "Описание для доступности", required: true, full: true }, { name: "order", label: "Порядок", type: "number" }, { name: "isPublished", label: "Опубликовано", type: "checkbox" },
];
