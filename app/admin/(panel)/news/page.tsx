...
const fields: FieldSpec[] = [
  { name: "title", label: "Заголовок", required: true, full: true }, { name: "slug", label: "Slug", required: true, autoSlugFrom: "title" }, { name: "category", label: "Категория", required: true }, { name: "publishedAt", label: "Дата публикации", type: "datetime-local", required: true }, { name: "imageUrl", label: "Обложка", type: "image", full: true }, { name: "excerpt", label: "Анонс", type: "textarea", required: true, full: true }, { name: "content", label: "Текст", type: "textarea", required: true, full: true }, { name: "isPublished", label: "Опубликована", type: "checkbox" },
];
