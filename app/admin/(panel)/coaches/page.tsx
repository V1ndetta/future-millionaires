...
const fields: FieldSpec[] = [
  { name: "name", label: "Имя", required: true }, { name: "role", label: "Роль", required: true }, { name: "rank", label: "Звание", required: true }, { name: "experience", label: "Опыт, лет", type: "number", required: true }, { name: "imageUrl", label: "Фотография", type: "image", full: true }, { name: "achievements", label: "Ключевые достижения", required: true, full: true }, { name: "bio", label: "Биография", type: "textarea", required: true, full: true }, { name: "order", label: "Порядок", type: "number" }, { name: "isPublished", label: "Опубликован", type: "checkbox" },
];
