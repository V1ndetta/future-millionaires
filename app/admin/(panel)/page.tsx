...
export default async function AdminDashboardPage() {
  const [leads, coaches, programs, schedules, achievements, news] = await Promise.all([getLeads(), getCoaches(true), getPrograms(true), getSchedules(true), getAchievements(true), getNews(true)]);
